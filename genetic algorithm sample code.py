...
Original file is located at
    https://colab.research.google.com/drive/1H5Eneer_EUCX9QzXDxIZcPb_3XZNvgEW
"""

import random

# Problem Data
classes = ["Math", "Physics", "Chemistry", "Biology", "History", "English"]
teachers = ["T1", "T2", "T3", "T4", "T5"]
rooms = ["R1", "R2", "R3"]
room_capacities = {"R1": 30, "R2": 40, "R3": 50}
timeslots = ["T1", "T2", "T3", "T4", "T5"]
student_counts = {"Math": 25, "Physics": 35, "Chemistry": 20, "Biology": 40, "History": 30, "English": 10}
...
def genetic_algorithm():
    ...
    for generation in range(GENERATIONS):
        ...
        #   print(f'Fitness {f}: {fitness_scores[f]}')
        ...
        # Step 5: Mutation
        population1 = [mutate(schedule) for schedule in next_generation]
        # print('HERE IS THE POP: ' ,population)
